...
public class UtilCategoriesPage {
    ...
    private static ArrayList<String> categoriesMainPage(Banner banner) {
        ...
        lines.addAll(UtilBootstrap.generateTitle("LunaDB listing"));
    ...
    private static ArrayList<String> getCategoryPage(RawCategory category, boolean exists, Banner banner) {
        ...
        lines.addAll(UtilBootstrap.containerOpen());
        lines.add("<br>");
        lines.add("<form class=\"well span9\" method=\"GET\" action=\"/categories?-" + category.getName() + "-" + "\">");
        lines.add("<div class=\"input-group input-group-lg\">");
        lines.add("<span class=\"input-group-addon\" id=\"sizing-addon1\">insert</span>");
        lines.add("<input type=\"text\" class=\"form-control\" placeholder=\"Key\" name=\"createcategory\" aria-describedby=\"sizing-addon1\">");
        lines.add("</div>");
        lines.add("</form>");
        lines.add("<br>");
        lines.addAll(UtilBootstrap.containerClose());
